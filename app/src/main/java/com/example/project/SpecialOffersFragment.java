...
public class SpecialOffersFragment extends Fragment implements CarMenuAdapter.OnReserveButtonClickListener, CarMenuAdapter.OnFavoriteButtonClickListener, CarMenuAdapter.OnLayoutButtonClickListener   {

    private List<Cars> dealerCars;
    private List<Cars> offers;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        carMenuRecyclerView = rootView.findViewById(R.id.MenuRecyclerView);
        ...
        offers = db.getOffers(dealerId);

        carMenuAdapter = new CarMenuAdapter(offers, this, this, this);
    ...
    public void onLayoutButtonClick(int position, List<Cars> filtered) {
        ...
        bundle.putString("carPrice", String.valueOf(clickedCar.getOfferPrice()));
